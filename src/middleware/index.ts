...
import authorApplicationDecide from './author-application-decide'
...
import editorsCount from './editors-count'
...
export default function (app: Application): void {
  ...
  app.use('/accounts/editors', editorsCount(app))
  ...
  app.use('/applications/:id/decide', authorApplicationDecide(app))
